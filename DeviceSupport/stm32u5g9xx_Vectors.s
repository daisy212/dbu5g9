...
File      : stm32u5g9xx_Vectors.s
Purpose   : Exception and interrupt vectors for stm32u5g9xx devices.
...
_vectors:
        ...
        ISR_HANDLER PWR_S3WU_IRQHandler
        ...
        ISR_HANDLER GPDMA1_Channel12_IRQHandler
        ISR_HANDLER GPDMA1_Channel13_IRQHandler
        ISR_HANDLER GPDMA1_Channel14_IRQHandler
        ISR_HANDLER GPDMA1_Channel15_IRQHandler
        ...
        ISR_HANDLER MDF1_FLT0_IRQHandler
        ISR_HANDLER MDF1_FLT1_IRQHandler
        ISR_HANDLER MDF1_FLT2_IRQHandler
        ISR_HANDLER MDF1_FLT3_IRQHandler
        ISR_HANDLER UCPD1_IRQHandler
        ISR_HANDLER ICACHE_IRQHandler
        ISR_HANDLER OTFDEC1_IRQHandler
        ISR_HANDLER OTFDEC2_IRQHandler
        ISR_HANDLER LPTIM4_IRQHandler
        ISR_HANDLER DCACHE1_IRQHandler
        ISR_HANDLER ADF1_IRQHandler
        ISR_HANDLER ADC4_IRQHandler
        ISR_HANDLER LPDMA1_Channel0_IRQHandler
        ISR_HANDLER LPDMA1_Channel1_IRQHandler
        ISR_HANDLER LPDMA1_Channel2_IRQHandler
        ISR_HANDLER LPDMA1_Channel3_IRQHandler
        ISR_HANDLER DMA2D_IRQHandler
        ISR_HANDLER DCMI_PSSI_IRQHandler
        ISR_HANDLER OCTOSPI2_IRQHandler
        ISR_HANDLER MDF1_FLT4_IRQHandler
        ISR_HANDLER MDF1_FLT5_IRQHandler
        ISR_HANDLER CORDIC_IRQHandler
        ISR_HANDLER FMAC_IRQHandler
        ISR_HANDLER LSECSSD_IRQHandler
        ISR_HANDLER USART6_IRQHandler
        ISR_HANDLER I2C5_ER_IRQHandler
        ISR_HANDLER I2C5_EV_IRQHandler
        ISR_HANDLER I2C6_ER_IRQHandler
        ISR_HANDLER I2C6_EV_IRQHandler
        ISR_HANDLER HSPI1_IRQHandler
        ISR_HANDLER GPU2D_IRQHandler
        ISR_HANDLER GPU2D_ER_IRQHandler
        ISR_HANDLER GFXMMU_IRQHandler
        ISR_HANDLER LTDC_IRQHandler
        ISR_HANDLER LTDC_ER_IRQHandler
        ISR_HANDLER DSI_IRQHandler
        ISR_HANDLER DCACHE2_IRQHandler
        ISR_HANDLER GFXTIM_IRQHandler
